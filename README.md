...
>
> If you are using FOSSBilling and wish to upgrade to **FOSSBilling v0.8.2**, please refer to the **FOSSBilling Upgrade Path** in [`docs/upgrade.md`](docs/upgrade.md).
