...
echo "This will update Namingo Registrar from v1.1.6 to v1.1.7"
...
if [[ -s /var/www/di.php ]]; then
    ...
    echo
    echo "Namingo Registrar v1.1.7 includes FOSSBilling v0.8.3"
...
echo "Cloning v1.1.7 from the repository..."
git clone --branch v1.1.7 --single-branch https://github.com/getnamingo/registrar /opt/registrar117
...
copy_files "/opt/registrar117/automation" "/opt/registrar/automation"
copy_files "/opt/registrar117/whois" "/opt/registrar/whois"
copy_files "/opt/registrar117/rdap" "/opt/registrar/rdap"
copy_files "/opt/registrar117/tests" "/opt/registrar/tests"
copy_files "/opt/registrar117/docs" "/opt/registrar/docs"
...
if [[ $? -eq 0 ]]; then
    echo "Services started successfully. Deleting /opt/registrar117..."
    rm -rf /opt/registrar117
else
    echo "There was an issue starting the services. /opt/registrar117 will not be deleted."
fi

# Final instructions to the user
echo
echo "=== Upgrade to v1.1.7 Complete ==="
echo
