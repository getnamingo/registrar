...
echo "This will update Namingo Registrar from v1.1.3 to v1.1.4"
...
echo "Cloning v1.1.4 from the repository..."
git clone --branch v1.1.4 --single-branch https://github.com/getnamingo/registrar /opt/registrar114
...
copy_files "/opt/registrar114/automation" "/opt/registrar/automation"
copy_files "/opt/registrar114/whois" "/opt/registrar/whois"
copy_files "/opt/registrar114/rdap" "/opt/registrar/rdap"
copy_files "/opt/registrar114/tests" "/opt/registrar/tests"
...
echo
echo "=== Upgrade to v1.1.4 Complete ==="
echo
