...
echo "This will update Namingo Registrar from v1.1.0 to v1.1.1"
...
echo "Cloning v1.1.1 from the repository..."
git clone --branch v1.1.1 --single-branch https://github.com/getnamingo/registrar /opt/registrar111
...
copy_files "/opt/registrar111/automation" "/opt/registrar/automation"
copy_files "/opt/registrar111/whois" "/opt/registrar/whois"
copy_files "/opt/registrar111/rdap" "/opt/registrar/rdap"
copy_files "/opt/registrar111/tests" "/opt/registrar/tests"
...
if [[ $? -eq 0 ]]; then
    echo "Services started successfully. Deleting /opt/registrar111..."
    rm -rf /opt/registrar111
else
    echo "There was an issue starting the services. /opt/registrar111 will not be deleted."
fi

# Final instructions to the user
echo
echo "=== Upgrade to v1.1.1 Complete ==="
echo
