...
echo "This will update Namingo Registrar from v1.1.5 to v1.1.6"
...
echo "Cloning v1.1.6 from the repository..."
git clone --branch v1.1.6 --single-branch https://github.com/getnamingo/registrar /opt/registrar115
...
echo
echo "=== Upgrade to v1.1.6 Complete ==="
echo
