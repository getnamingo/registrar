...
echo "This will update Namingo Registrar from v1.2.1 to v1.2.2"
...
if [[ -s /var/www/di.php ]]; then
    ...
    echo
    echo "Namingo Registrar v1.2.2 includes FOSSBilling v0.8.5"
...
echo "Cloning v1.2.2 from the repository..."
git clone --branch v1.2.2 --single-branch https://github.com/getnamingo/registrar /opt/registrar122
...
copy_files "/opt/registrar122/automation" "/opt/registrar/automation"
copy_files "/opt/registrar122/whois" "/opt/registrar/whois"
copy_files "/opt/registrar122/rdap" "/opt/registrar/rdap"
copy_files "/opt/registrar122/tests" "/opt/registrar/tests"
copy_files "/opt/registrar122/docs" "/opt/registrar/docs"
...
if [[ $? -eq 0 ]]; then
    echo "Services started successfully. Deleting /opt/registrar122..."
    rm -rf /opt/registrar122
else
    echo "There was an issue starting the services. /opt/registrar122 will not be deleted."
fi

# Final instructions to the user
echo
echo "=== Upgrade to v1.2.2 Complete ==="
echo
